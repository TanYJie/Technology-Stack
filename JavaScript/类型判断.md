...
　　下面是我自己写的类型判断函数，适合 JavaScript 所有数据类型，有问题请及时指出。
...
下面是 **JavaScript 引用类型** 的大致关系图：
  
  ![引用类型](https://github.com/TanYJie/Technology-Stack-Interview-Experience/blob/master/JavaScript/image/JS引用数据类型.png)
